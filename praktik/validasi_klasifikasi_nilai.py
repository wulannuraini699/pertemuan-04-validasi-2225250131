...
# Spesifikasi:
# 1. Validasi tipe angka menggunakan try-except
# 2. Validasi rentang 0-100 untuk ketiga input
# 3. Nilai akhir = 0.6 * ujian + 0.4 * tugas
# 4. Syarat kehadiran minimal 80%
# 5. Klasifikasi predikat (A, B, C, D, E) dan status lulus (A, B, C) / belum lulus (D, E)
